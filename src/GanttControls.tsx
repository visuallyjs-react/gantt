...
export default function GanttControls() {
    ...
    return <div className="vjs-gantt-controls">
        <button onClick={() => gantt!.addNewTask()} title="New Task">
        ...
        <button onClick={() => gantt!.addNewTaskGroup()} title="New Task Group">
        ...
        <button onClick={() => gantt!.addNewMilestone()} title="New Milestone">
